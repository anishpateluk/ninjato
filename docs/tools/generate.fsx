...
let githubLink = "http://github.com/anishpateluk/ninjato"

// Specify more information about your project
let info =
  [ "project-name", "Ninjato"
    "project-author", "Anish Patel"
    "project-summary", "Reporting Service Application"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Ninjato" ]
